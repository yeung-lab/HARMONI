...
from constants import smil_model_path, smpl_model_path
...
class TemporalSMPLify():
    ...
    def __init__(self,
        ...
        # GMM pose prior
        self.pose_prior = MaxMixturePrior(prior_folder='data/body_models',
                                          num_gaussians=8,
    ...
    def __call__(self, body_type, init_global_orient, init_pose, init_betas, init_cam_t, camera_center, keypoints_2d, 
        ...
        if body_type == 'smpl':
            ...
            model_path = smil_model_path

        batch_size = init_pose.shape[0]
        self.smpl = init_body_model(model_path, batch_size=batch_size, create_body_pose=True, create_transl=False).to(self.device)
