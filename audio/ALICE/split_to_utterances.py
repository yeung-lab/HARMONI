...
curdir = sys.argv[1] # refers to ALICE subfolder
outputdir = sys.argv[2]
datadir = sys.argv[3]
file = os.path.splitext(os.path.basename(datadir))[0]
rttm_file = os.path.join(outputdir, file) + '.rttm'

valid_speakers = ['FEM','MAL']

DATA = []
with open(rttm_file) as csv_file:
