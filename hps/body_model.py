...
def init_body_model(model_path, batch_size, create_body_pose, create_transl=True):
    ...
    model_params = dict(batch_size=batch_size, create_transl=create_transl, joint_mapper=joint_mapper,
